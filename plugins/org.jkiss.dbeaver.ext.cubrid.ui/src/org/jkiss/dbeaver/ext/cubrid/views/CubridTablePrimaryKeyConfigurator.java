...
import org.jkiss.dbeaver.ext.cubrid.model.CubridTableConstraintColumn;
...
/**
 * Cubrid table primary key configurator
 */
public class CubridTablePrimaryKeyConfigurator implements DBEObjectConfigurator<CubridUniqueKey> {


    @Override
    public CubridUniqueKey configureObject(DBRProgressMonitor monitor, Object table, CubridUniqueKey primaryKey, Map<String, Object> options) {
            ...
            protected CubridUniqueKey runTask() {
                ...
                for (DBSEntityAttribute tableColumn : editPage.getSelectedAttributes()) {
                    primaryKey.addColumn(
                        new CubridTableConstraintColumn(
                            primaryKey,
